...
abstract class CelestialBodyRepository {
  ...
  Future<Either<Failure, void>> updateBlackHole(BlackHole entity);
  ...
  Future<Either<Failure, void>> updateStar(Star entity);
  ...
  Future<Either<Failure, void>> updatePlanet(Planet entity);
  ...
  Future<Either<Failure, void>> updateMoon(Moon entity);
  ...
  Future<Either<Failure, void>> updateAsteroid(Asteroid entity);
